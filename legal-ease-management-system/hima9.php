  ...
  <div class="row">
    ...
    <div class="column">
      <form action="/action_page.php">
        <br><label for="fname">First Name : Sifon Colins</label></br>
		<br><label for="Education">Education  : LLB and LLM</label></br>
		<br><label for="Address">Address : Gbagada, Lagos</label></br>
		...
		<br><label for="Appointment">Appointment : www.sifonsolins.com</label></br>
        <br><label for="phone no">Phone no : 9854763210</label></br>
        <br><label for="Experience"> Experience :27 years experienced in the law field </label></br>
