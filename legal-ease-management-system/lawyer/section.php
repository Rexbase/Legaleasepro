      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-10 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
          	<h2 class="subheading" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">online court case Management</h2>
        ...
        <div class="row no-gutters d-flex">
          <div class="col-md-3 text-center services align-self-stretch ftco-animate p-4">
            ...
            <div class="media-body">
              ...
              <p>Reach out to the lawyer of your choice and provide a brief overview of your issue or the situation for which you require legal services, without sharing any confidential information.</p>
            </div>
          </div>
          <div class="col-md-3 text-center services align-self-stretch ftco-animate p-4">
            ...
            <div class="media-body">
              ...
              <p>Leverage industry-specific expertise. Gain a competitive edge by partnering with top lawyers who specialize in your business domain.</p>
            </div>
          </div>
          <div class="col-md-3 text-center services align-self-stretch ftco-animate p-4">
            ...
            <div class="media-body">
              ...
              <p>Have great discounted rates as compare to others lawyers.</p>
            </div>
          </div>
          <div class="col-md-3 text-center services align-self-stretch ftco-animate p-4">
            ...
            <div class="media-body">
              ...
              <p>You can review your case documents after submitting your case.</p>
            </div>
          </div>
        </div>
      </div>
		          ...
		          <div class="col-md-3 justify-content-center counter-wrap ftco-animate">
		            <div class="block-18 text-center py-4 bg-light mb-4">
		              <div class="text">
		                ...
		                <strong class="number" data-number="2319">0</strong>
        ...
        <div class="row d-flex justify-content-center">
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="https://www.latestlaws.com/library/legal-documents/legal-applications-family-courts/">Family Law</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="https://economictimes.indiatimes.com/topic/Business-Law/">Business Law</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="https://www.livemint.com/insurance/news">Insurance Law</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="https://en.wikipedia.org/wiki/Criminal_law">Criminal Law</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="http://14.139.60.114:8080/jspui/bitstream/123456789/738/21/Property%20Law.pdf">Property Law</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="https://legalcareerpath.com/what-is-employment-law/#:~:text=Employment%20law%20is%20the%20collection,the%20employee%20for%20their%20work.">Employment Law</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="https://www.casemine.com/search/in/fire%2Baccident%2Bcases">Fire Accident</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="https://www.investopedia.com/terms/f/financial-responsibility-law.asp#:~:text=What%20is%20Financial%20Responsibility%20Law,damages%20resulting%20from%20an%20accident.">Financial Law</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="https://en.wikipedia.org/wiki/Drug_policy_of_India#:~:text=Under%20the%20NDPS%20Act%2C%20it,with%20effect%20from%20March%201986.">Drug Offenses</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="https://en.wikipedia.org/wiki/Child_sexual_abuse_laws_in_India#:~:text=Offences%20under%20the%20Act,-The%20Protection%20of&text=It%20recognises%20forms%20of%20penetration,Offences%20under%20the%20act%20include%3A&text=Child%20Pornography,Sexual%20Assault%2F%20Aggravated%20Sexual%20Assault">Sexual Offenses</a></h3>
        		</div>
        	</div>
        </div>
    	</div>
